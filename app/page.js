    ...
    <>
      ...
      <main>
              ...
              <CarouselContent>
                {Array(6).fill("").map((_, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <Image alt="logo png's" src="./logobar.png" className="border-2 border-black mx-auto" width={150} height={150} />
                  </CarouselItem>
                ))}
              </CarouselContent>
          ...
          <div id="services" className="grid grid-col-1 md:grid-cols-2 gap-5 md:gap-10 container">
            ...
            <div className="md:col-start-2 md:row-start-1 md:row-span-2 flex flex-col gap-5">
              {["iOS development", "Android development", "Web development", "UI/UX design", "Testing", "Launch", "IT consulting"].map((service, index) => (
                <Link key={index} href="#" className="hover:underline underline-offset-4 decoration-primary">
        ...
        <section id="faq" className="bg-background md:px-14 py-10 container">
          <div>
            <h2 className="md:text-3xl text-2xl font-bold my-5">FAQ</h2>
